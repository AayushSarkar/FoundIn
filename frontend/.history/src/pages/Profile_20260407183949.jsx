...
export default function Profile() {
  ...
  <div className="space-y-10">
    ...
    {/* 🔷 HEADER */}
   <div className="bg-gradient-to-r from-slate-800 via-slate-700 to-slate-900 h-44 rounded-2xl shadow-xl relative">

  {/* PROFILE INFO */}
  <div className="absolute left-10 -bottom-14 flex items-center gap-5">
