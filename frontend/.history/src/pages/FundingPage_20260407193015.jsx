...
export default function FundingPage() {
  ...
  {/* MEANING TEXT (IMPORTANT) */}
  <div className="flex justify-between text-sm font-medium text-black">
    <span>Low (Just an Idea)</span>
    <span>Medium (Some Validation)</span>
    <span>High (Strong Confidence)</span>
  </div>
  ...
  <p className="text-xs text-gray-500">
    Selected: {form.confidenceLevel}/10
  </p>
  ...
  {/* MEANING TEXT */}
  <div className="flex justify-between text-sm font-medium text-black">
    <span>Low (Founder Control)</span>
    <span>Balanced Deal</span>
    <span>High (Investor Heavy)</span>
  </div>
  ...
  <input
    ...
    onChange={(e) =>
      setForm((prev) => ({
        ...prev,
        equityOffered: Number(e.target.value),
      }))
    }
