        ...
        <div className="flex-1 p-10 space-y-8">
          ...
          {tab === "profile" && (
            <div className="space-y-10">
                ...
                {pitches.length > 0 ? (
                  pitches.map((p) => (
                    <div key={p._id} className="border p-4 rounded-xl">
                      <h3 className="font-semibold text-lg">{p.startupName}</h3>
                      <p className="text-gray-500">{p.tagline}</p>
                      <p className="text-sm mt-2">{p.description}</p>
                      <p className="text-sm mt-2">
                        💰 ₹{p.fundingRequired} | Equity: {p.equityOffered}%
                      </p>
                    </div>
                  ))
                ) : (
              ...
              {/* FUNDING */}
              <div className="bg-white border rounded-2xl p-6 space-y-4 shadow-sm">
                <h2 className="text-xl font-semibold">💰 Funding Rounds</h2>

                {fundings.length > 0 ? (
                  fundings.map((f) => (
                    <div key={f._id} className="border p-4 rounded-xl">
                      ...
                      <p className="text-sm mt-2">
                        💰 ₹{f.fundingAmount} | Equity: {f.equityOffered}%
                      </p>
                    </div>
                  ))
                ) : (
          ...
          {tab === "settings" && (
            <div className="space-y-6">
              ...
              <div className="bg-white border p-6 rounded-xl space-y-4">
                <p className="text-sm text-gray-500">Choose Avatar</p>
                <div className="flex gap-4">
                  {avatars.map((img) => (
                    <img
                      key={img}
          ...
          {tab === "policies" && (
            <div>
              ...
              <p className="text-gray-600 mt-4">
                Platform policies and guidelines apply to all users.
              </p>
            </div>
          )}
