...
export default function Profile() {
  ...
  return (
    <Layout>
      <div className="flex max-w-7xl mx-auto mt-2 bg-white rounded-2xl shadow-lg overflow-hidden">
  ...
  <div className="space-y-10">
    ...
    {/* 🔷 HEADER */}
    <div className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 h-40 rounded-2xl shadow-lg">
