      ...
      <section className="flex flex-col md:flex-row items-center justify-between px-10 py-20">
        <div className="max-w-xl">
          <h2 className="text-5xl font-bold mb-6 leading-tight">
            Discover, Build & Grow Ideas with <span className="text-blue-600">FoundIn</span>
          </h2>
        ...
        {/* Lottie */}
        <div className="w-[350px] md:w-[500px] mt-10 md:mt-0">
        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {["Innovation", "Collaboration", "Growth"].map((item, i) => (
              ...
              >
                <h4 className="font-semibold text-blue-600 text-lg">{item}</h4>
              </motion.div>
            ))}
