...
export default function Profile() {
  ...
  <div className="space-y-10">
    ...
    {/* 🔷 HEADER */}
    <div className="relative bg-linear-to-r from-slate-800 via-slate-700 to-slate-900 h-40 rounded-2xl shadow-lg">
...
<div className="bg-white rounded-2xl p-6 shadow-md border border-gray-100">
  ...
  <div className="grid lg:grid-cols-3 gap-6 items-center">
      ...
      {pitches.length > 0 ? (
        <div className="grid md:grid-cols-2 gap-6">
          {pitches.map((p) => (
            <div
              key={p._id}
              className="p-5 rounded-xl border border-gray-100 shadow-sm hover:shadow-xl transition bg-gradient-to-br from-white to-gray-50"
            >
    ...
    <div className="flex justify-center">
      <div className="w-[220px] lg:w-[260px]">
        ...
        <>
          ...
          <button
            onClick={handlePitchSubmit}
            className="bg-linear-to-r from-blue-500 to-indigo-500 text-white px-6 py-2 rounded-lg shadow hover:opacity-90"
          >
            Submit Pitch
          </button>
        </>
    ...
    <div className="bg-white rounded-2xl p-2 shadow-md border border-gray-100">
      <h2 className="text-xl font-semibold mb-6 flex items-center gap-0">
        💰 Funding Rounds
      </h2>
