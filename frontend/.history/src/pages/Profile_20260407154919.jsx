...
export default function Profile() {
  ...
  <div className="space-y-10">
    ...
    <div>
      ...
      <div className="border p-4 rounded-lg text-gray-600">
        <p>
          This platform currently uses a light theme for better readability and
    ...
    <div>
      ...
      <div className="border border-red-200 p-4 rounded-lg space-y-4">
