          ...
          {tab === "activity" && (
            <div className="space-y-6">
              ...
              <div className="bg-white border p-6 rounded-xl">
                🚀 Your submitted pitches and funding requests will appear here.
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border p-6 rounded-xl space-y-4">
                <p className="text-gray-600">
                  We respect your privacy and ensure secure handling of user data.
                </p>
                <p className="text-gray-600">
                  Users must follow ethical guidelines and platform rules.
                </p>
                <p className="text-gray-600">
                  Policies may change over time and continued use implies acceptance.
                </p>
              </div>
            </div>
          )}
