      ...
      <div className="flex max-w-7xl mx-auto mt-10 bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="flex-1 p-10 space-y-10">
          ...
          {tab === "profile" && (
            <>
              {/* HEADER */}
              <div className="bg-gradient-to-r from-blue-500 to-indigo-500 h-32 rounded-xl"></div>
              ...
              {/* 🚀 PITCH SECTION */}
              <div className="bg-white border rounded-2xl p-6 shadow-sm">
                <h2 className="text-xl font-semibold mb-4">🚀 Your Pitch</h2>
                    ...
                    {pitches.map((p) => (
                      ...
                      >
                        ...
                        <div className="flex justify-between mt-3 text-sm">
                          <span>💰 ₹{p.fundingRequired}</span>
                          <span>Equity: {p.equityOffered}%</span>
                        </div>
                      </div>
                    ))}
                  </div>
                    ...
                    {fundings.map((f) => (
                      ...
                      >
                        ...
                        <div className="flex justify-between text-sm mb-4">
                          ...
                          <span>Equity: {f.equityOffered}%</span>
                        </div>

                        {/* EXTRA INFO */}
                        <div className="text-xs text-gray-400 space-y-1">
                          <p>👥 Team Size: {f.teamSize}</p>
                          <p>⏳ Timeline: {f.expectedTimeline}</p>
                        </div>
                        ...
                        {/* LINKS */}
                        <div className="flex gap-3 mt-4 text-xs text-blue-500">
                          <a href={f.links?.website} target="_blank">
                            Website
                          </a>
                          <a href={f.links?.linkedin} target="_blank">
                            LinkedIn
                          </a>
                          <a href={f.links?.github} target="_blank">
                            GitHub
                          </a>
                        </div>
                      </div>
          ...
          {tab === "Change avatar" && (
            <div className="space-y-6">
              <h1 className="text-3xl font-semibold">Change avatas</h1>
